            ...
            <div class="card card-user">
                <div class="card-body">
                    ...
                    <div class="author">
                        ...
                        <a href="#">
                            <img class="avatar" src="/image/{{$user->image->path}}" alt="">
                 ...
                 <div class="card-footer">
                     <div class="button-container">
                         @if(\App\User::isMyFrind($user->id))
                             <button class="btn btn-icon btn-round btn-facebook">
                                 <a href="/user/FrindRequest/{{$user->id}}" class="tim-icons icon-simple-remove" ><i class="tim-icons icon-simple-remove"></i></a>
                             </button>
                             @elseif(\App\User::isAddFrindRequest($user->id)->isNotEmpty())
                                 <button class="btn btn-icon btn-round btn-facebook">
                                     <a href="/user/FrindRequest/{{$user->id}}" class="tim-icons icon-refresh-02" ><i class="tim-icons icon-refresh-02"></i></a>
                                 </button>
                             @else
                             <button class="btn btn-icon btn-round btn-facebook">
                                 <a href="/user/FrindRequest/{{$user->id}}" class="tim-icons icon-simple-add" ><i class="tim-icons icon-simple-add"></i></a>
                             </button>
                             @endif
